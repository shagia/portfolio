...
THREE.OrbitControls = function ( object, domElement ) {
	...
	function zoomModel(isZoomOut, scale) {
				...
				//It works oh god...this sets a true/false value determining if the menu is showing
		  		$("#cameraZoomOut").on("click", function(){
		  			var menu = document.getElementById('cameraZoomOut');
